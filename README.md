The developed project is mainly used for predicting the criminal activities across Indian states from the already existing data. The data here is taken from dataworld.
